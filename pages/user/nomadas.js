...
export default function Nomadas() {
  ...
  <div class="w-full h-48 bg-amber-50"></div>
  <p class="absolute top-8 sm:top-10 left-8 right-0 bottom-0   text-red-600 text-sm sm:text-1xl font-semibold">Edgar Robles</p> 
  <p class="absolute top-14 sm:top-16 pr-40 sm:pr-96 pl-7 text-gray-600 text-[8px] sm:text-xs" > 
  Soy un nmado de jalisco,apasionado por
  la aventura, la adrenalina y
  los recorridos que involucren fiesta y 
  buenos amigos, permiteme ayudarte a 
  descubrir jalisco.
  mi mision *Jalisco es mi hogar, y mi pasión
  es compartir su belleza y cultura con el mundo* </p> 

  <p class="absolute top-14 sm:top-16 lg:top-8 left-40 sm:left-96 pr-28 sm:pr-16 pl-7 text-gray-600 text-[8px] sm:text-xs" > 
  Soy un nmado de jalisco,apasionado por
  la aventura, la adrenalina y 
  los recorridos que involucren fiesta y 
  buenos amigos, permiteme ayudarte a 
  ...
  es compartir su belleza y cultura con el mundo* </p>
   ...
   <div className="relative flex"> 
    ...
    <div className="relative">
    <img src="/imgNomadas/resenas.webp" alt="" class="w-full h-44 sm:h-60" />
    <p class="absolute bottom-24 sm:bottom-32 left-3 text-sm sm:text-3xl text-black hover:text-red-400 px-2 py-1 font-bold">MIS AMIGOS HABLAN POR MI</p>       
         <p class= "absolute bottom-14 sm:bottom-10 left-0  sm:left-3 text-[8px] sm:text-lg text-white px-2 py-1 text-center pr-32 sm:pr-60">No me creas a mi, puedes checar las reseñas de mis 
         amigos que me han venido a visitar y hemos dado una vueltas por la ciudad juntos.</p>
         <button
         class="absolute none top-20 sm:top-28 left-60 sm:left-3/4 rounded-lg bg-gradient-to-tr from-red-500 to-orange-500 py-2 sm:py-4 px-4 sm:px-8 font-sans text-[8px] sm:text-[10px] font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
         Reseñas
         </button>
    </div>
    ...
    <button
         class="absolute none top-28 sm:top-52 left-6 sm:left-[60px]  rounded-lg bg-gradient-to-tr from-red-500 to-orange-500 py-1 sm:py-2 px-2 sm:px-4 font-sans text-[4px] sm:text-[7px] font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
         Mas info
         </button>
    </div>
    ...
    <div class="absolute bottom-6 left-4 sm:left-[30px] w-20 sm:w-48 h-32 sm:h-60  bg-amber-100">
    <p class= "absolute bottom-12 sm:bottom-20 left-2 sm:left-[28px] text-[4px] sm:text-[10px] text-orange-500 px-2 py-1 text-center pr-2 font-bold ">TONALA RUTA ALFARERA</p>
    <img src="/imgNomadas/Tonala.png" alt="" class=" w-16 sm:w-44 h-14 sm:h-32 absolute top-2 left-2" />
    <p class= "absolute bottom-4 sm:bottom-8 left-0 text-[5px] sm:text-[10px] text-orange-500 px-2 py-1 text-center pr-2 ">Demos una vuelta por tonala, y conozcamos su tianguis de artesanias y porque es la capital alfarera </p>
    <button
         class="absolute none top-28 sm:top-52 left-6 sm:left-[60px] rounded-lg bg-gradient-to-tr from-red-500 to-orange-500 py-1 sm:py-2 px-2 sm:px-4 font-sans text-[4px] sm:text-[7px] font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
         Mas info
         </button> 
