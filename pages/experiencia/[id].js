...
const features = [
  ...
  export default function Example() {
    ...
    return (
      <SideBar >
        <section aria-labelledby="features-heading" className="relative bg-gray-700">
          ...
          <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 sm:pb-32 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:pt-32">
            <div className="lg:col-start-2">
              ...
              <p className="mt-4 text-gray-500">
                ve obsessed over every detail of this handcrafted journal to bring you the best materials for daily
                use.
              </p>
